...
QTableModel* LM::QshowBorrowReq() const {
    return data->borrowReq.Qshow();
}
...
QTableModel* LM::QshowReturnReq() const {
    return data->returnReq.Qshow();
}
...
QTableModel *Library::ManagerOperation::QschReader(const string &s) const {
    return data->rl.QschReader(s);
}

QTableModel* LM::Qschrid(const string &s) const {
    return data->rl.Qschrid(s);
}

QTableModel* LM::Qschrname(const string &s) const {
    return data->rl.Qschrname(s);
}
...
QTableModel* LM::QschHistory(const string &s) const {
    return data->hl.QschHistory(s);
}
